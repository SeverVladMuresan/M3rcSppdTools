...
test_time_delta = datetime.timedelta(hours=2)
...
expired_card_requests = card_request_service.get_expired_card_requests(test_time_delta)
print(human_friendlyfy_card_requests(expired_card_requests))
